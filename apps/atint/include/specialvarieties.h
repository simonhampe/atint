 ...
 * @return A WeightedComplex object representing L^n_k
 */
...
@param WeightedComplex fan_skeleton The n-rank(matroid)-skeleton of the normal fan of the matroid polytope
...
@return WeightedComplex The bergman fan of the matroid, possibly with the lineality space divided out
*/
