...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   FunctionWrapper4perl( void (pm::Matrix<pm::Rational>&, bool) ) {
      perl::Value arg0(stack[0]), arg1(stack[1]);
      IndirectWrapperReturnVoid( arg0.get< perl::TryCanned< Matrix< Rational > > >(), arg1 );
   }
   FunctionWrapperInstance4perl( void (pm::Matrix<pm::Rational>&, bool) );

   FunctionWrapper4perl( std::pair<pm::Matrix<pm::Rational>, pm::Matrix<pm::Rational> > (pm::Matrix<pm::Rational>, pm::Matrix<pm::Rational>, pm::Matrix<pm::Rational>, pm::Matrix<pm::Rational>, bool) ) {
