...
///==== Automatically generated contents follow.    Please do not delete this line. ====
   ...
   FunctionWrapper4perl( pm::Matrix<pm::Integer> (pm::Matrix<pm::Integer> const&, pm::Integer&) ) {
      perl::Value arg0(stack[0]), arg1(stack[1]);
      IndirectWrapperReturn( arg0.get< perl::TryCanned< const Matrix< Integer > > >(), arg1.get< perl::TryCanned< Integer > >() );
   }
   FunctionWrapperInstance4perl( pm::Matrix<pm::Integer> (pm::Matrix<pm::Integer> const&, pm::Integer&) );

   FunctionWrapper4perl( pm::Vector<pm::Integer> (pm::Matrix<pm::Rational>, pm::Matrix<pm::Rational>, pm::Vector<pm::Rational>) ) {
   ...
   FunctionWrapperInstance4perl( pm::Vector<pm::Integer> (pm::Matrix<pm::Rational>, pm::Matrix<pm::Rational>, pm::Vector<pm::Rational>) );
